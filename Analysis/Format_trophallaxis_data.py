...
for colony in [1,2,3]:
    for density in ['high','low']:
        working_df=pd.read_excel('../Data/Trophallaxis/Colony_'+str(colony)+'_trophallaxis_final.xlsx',sheetname=density+' density')
...
#                ID_dict[ID]=len(ID_list)-1
        ...
        working_df.to_csv('../Data/Trophallaxis/Colony_'+str(colony)+'_'+density+'_formatted.txt', sep='\t')
